...
export default function Management({ storeCode }: Props) {
  ...
  return (
    <>
      <h2 className="text-2xl font-bold mb-10">메뉴 관리</h2>
      <div className="w-full min-h-[calc(100vh-3rem)] max-h-fit p-10 bg-white flex flex-col rounded-2xl">
        ...
        <table className="border-y-2 border-y-gray-100">
          <thead className="text-left">
            <tr className="bg-gray-200">
              <th className="border-2 border-l-0 border-gray-300 p-2">
                메뉴 명
              </th>
